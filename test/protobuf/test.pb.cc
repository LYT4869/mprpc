...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, _impl_.users_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".fixbug.ResultCode\022\033\n\005users\030\002 \003(\0132\014.fixb"
  "ug.User2\226\001\n\016UserServiceRpc\0224\n\005Login\022\024.fi"
  "xbug.LoginRequest\032\025.fixbug.LoginResponse"
  "\022N\n\rGetFrendLists\022\035.fixbug.GetFriendList"
  "sRequest\032\036.fixbug.GetFriendListsResponse"
...
void UserServiceRpc::GetFrendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListsRequest*,
                         ::fixbug::GetFriendListsResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFrendLists() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::GetFrendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
